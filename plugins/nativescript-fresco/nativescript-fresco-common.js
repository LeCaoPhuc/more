...
exports.showIndicatorProperty = new view_1.Property({ name: 'showIndicator', defaultValue: false });
exports.stretchProperty = new view_1.Property({ name: 'stretch', defaultValue: 'aspectFit' });
exports.stretchProperty.register(FrescoDrawee);
exports.showIndicatorProperty.register(FrescoDrawee);
exports.resizeProperty.register(FrescoDrawee);

...
declare module com {
    module facebook {
        ...
        module imagepipeline {
            ...
            module core {
                class ImagePipeline {
                    isInBitmapMemoryCache(uri: any): boolean;
                    isInDiskCacheSync(uri: any): boolean;
                    evictFromMemoryCache(uri: any): void;
                    evictFromDiskCache(uri: any): void;
                    evictFromCache(uri: any): void;
                    clearCaches(): void;

...
export declare const resizeProperty: Property<FrescoDrawee, string>;
export declare const showIndicatorProperty: Property<FrescoDrawee, boolean>;
export declare const stretchProperty: Property<FrescoDrawee, Stretch>;
